...
class KedaiGajet extends StatefulWidget {
  static const routeName = "/KedaiGajet";

  final String? userEmail;

  const KedaiGajet({Key? key, this.userEmail}) : super(key: key);

  @override
  State<KedaiGajet> createState() => _ItemListPageState();
}

class _ItemListPageState extends State<KedaiGajet> {
  ...
  Future<void> _showConfirmationDialog(BuildContext context) async {
    ...
    if (removeItems == true) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (BuildContext context) => DisplayKedaiGajet(),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('gajet').where('email', isEqualTo: widget.userEmail).snapshots(),
          ...
          actions: [
            TextButton(
              ...
              onPressed: () async {
                ...
                Navigator.pushNamed(context, DisplayKedaiGajet.routeName);
              },
            ),
          ],
        );
...
void main() {
  runApp(MaterialApp(
    title: 'Kedai Gajet',
    initialRoute: KedaiGajet.routeName,
    routes: {
