...
class KedaiPakaian extends StatefulWidget {
  static const routeName = "/KedaiPakaian";

  final String? userEmail;

  const KedaiPakaian({Key? key, this.userEmail}) : super(key: key);

  @override
  State<KedaiPakaian> createState() => _ItemListPageState();
}

class _ItemListPageState extends State<KedaiPakaian> {
  ...
  Future<void> _showConfirmationDialog(BuildContext context) async {
    ...
    if (removeItems == true) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (BuildContext context) => DisplayKedaiPakaian(),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream:
            FirebaseFirestore.instance.collection('pakaian').where('email', isEqualTo: widget.userEmail).snapshots(),
          ...
          actions: [
            TextButton(
              ...
              onPressed: () async {
                ...
                Navigator.pushNamed(context, DisplayKedai.routeName);
              },
            ),
          ],
        );
...
void main() {
  runApp(MaterialApp(
    title: 'Kedai Pakaian',
    initialRoute: KedaiPakaian.routeName,
    routes: {
