...
class DisplayProfilePelanggan extends StatefulWidget {
  static const routeName = "/DisplayProfilePelanggan";

  @override
  _DisplayProfileState createState() => _DisplayProfileState();
}

class _DisplayProfileState extends State<DisplayProfilePelanggan> {
