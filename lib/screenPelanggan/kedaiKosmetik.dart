...
class KedaiKosmetik extends StatefulWidget {
  static const routeName = "/KedaiPakaian";

  final String? userEmail;

  const KedaiKosmetik({Key? key, this.userEmail}) : super(key: key);

  @override
  State<KedaiKosmetik> createState() => _ItemListPageState();
}

class _ItemListPageState extends State<KedaiKosmetik> {
  ...
  Future<void> _showConfirmationDialog(BuildContext context) async {
    ...
    if (removeItems == true) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (BuildContext context) => DisplayKedaiKosmetik(),
        ),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream:
            FirebaseFirestore.instance.collection('kosmetik').where('email', isEqualTo: widget.userEmail).snapshots(),
          ...
          actions: [
            TextButton(
              ...
              onPressed: () async {
                ...
                Navigator.pushNamed(context, DisplayKedaiKosmetik.routeName);
              },
            ),
          ],
        );
...
void main() {
  runApp(MaterialApp(
    title: 'Kedai Kosmetik',
    initialRoute: KedaiKosmetik.routeName,
    routes: {
