...
class MenuScreenPelanggan extends StatelessWidget {
  static const routeName = "/menuScreenPelanggan";
  @override
                          ...
                          child: Column(
                            ...
                            children: [
                              GestureDetector(
                                onTap: () {
                                  Navigator.of(context)
                                      .pushNamed(DisplayKedai.routeName);
                                },
                                child: MenuCard(
                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.of(context).pushNamed(
                                      DisplayKedaiKesihatan.routeName);
                                },
                                child: MenuCard(
                                  imageShape: Container(
                                    decoration: BoxDecoration(
                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.of(context)
                                      .pushNamed(DisplayKedaiPakaian.routeName);
                                },
                                child: MenuCard(
                                  imageShape: Container(
                                    decoration: BoxDecoration(
                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.of(context).pushNamed(
                                      DisplayKedaiKosmetik.routeName);
                                },
                                child: MenuCard(
                                  imageShape: Container(
                                    decoration: BoxDecoration(
                              ...
                              GestureDetector(
                                onTap: () {
                                  Navigator.of(context)
                                      .pushNamed(DisplayKedaiGajet.routeName);
                                },
                                child: MenuCard(
                                  imageShape: Container(
                                    decoration: BoxDecoration(
