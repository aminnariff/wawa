...
class DisplayKedaiGajet extends StatefulWidget {
  static const routeName = "/DisplayKedaiGajet";

  @override
  _DisplayKedaiState createState() => _DisplayKedaiState();
}

class _DisplayKedaiState extends State<DisplayKedaiGajet> {
  @override
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Senarai Kedai Gajet'),
      ),
      body: Stack(
        children: [
                    ...
                    child: ListTile(
                      ...
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => KedaiGajet(userEmail: email),
                          ),
                        );
                      },
                    ),
