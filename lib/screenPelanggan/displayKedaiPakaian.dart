...
class DisplayKedaiPakaian extends StatefulWidget {
  static const routeName = "/DisplayKedaiPakaian";

  @override
  _DisplayKedaiState createState() => _DisplayKedaiState();
}

class _DisplayKedaiState extends State<DisplayKedaiPakaian> {
  @override
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Senarai Kedai Pakaian'),
      ),
      body: Stack(
        children: [
