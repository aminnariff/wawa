...
class HomeScreenUsahawan extends StatefulWidget {
  static const routeName = "/HomeScreenUsahawan";

  @override
  _HomeScreenState createState() => _HomeScreenState();
}

class _HomeScreenState extends State<HomeScreenUsahawan> {
  String username = '';
      ...
      appBar: AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                Navigator.of(context).pushNamed(Pesanan.routeName);
              },
              child: Image.asset(
                Helper.getAssetName("shopping_bag.png", "virtual"),
                color: Colors
                    .white, // Set the color of the shopping bag icon to orange
              ),
            ),
          ],
        ),
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                border: Border.all(
                                  color: AppColor
                                      .orange, // Set the color of the border
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                border: Border.all(
                                  color: AppColor
                                      .orange, // Choose the border color you desire
                                  width:
                                      2.0, // Choose the border width you desire
                                ),
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                border: Border.all(
                                  color: AppColor
                                      .orange, // Set the desired border color
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                border: Border.all(
                                  color: AppColor
                                      .orange, // Set the border color here
                          ...
                          GestureDetector(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                border: Border.all(
                                  color: AppColor
                                      .orange, // Specify the border color here
                                  width: 2.0, // Specify the border width here
                                ),
                                borderRadius: BorderRadius.circular(
                                    10.0), // Specify the border radius here
                              ),
                              child: CategoryCard(
                                image: Image.asset(
