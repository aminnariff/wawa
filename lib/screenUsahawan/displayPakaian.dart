...
class DisplayPakaian extends StatefulWidget {
  static const routeName = "/DisplayPakaian";
  const DisplayPakaian({Key? key}) : super(key: key);

  @override
  State<DisplayPakaian> createState() => _ProductListPageState();
}

class _ProductListPageState extends State<DisplayPakaian> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('pakaian').snapshots(),
        ...
        child: ElevatedButton(
          onPressed: () {
            Navigator.of(context).push(
              MaterialPageRoute(builder: ((context) => AddPakaian())),
            );
          },
          child: Text(
            'Tambah',
