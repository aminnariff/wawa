...
class AddKesihatan extends StatefulWidget {
  static const routeName = "/AddKesihatan";
  const AddKesihatan({Key? key}) : super(key: key);

  @override
  _AddProductPageState createState() => _AddProductPageState();
}

class _AddProductPageState extends State<AddKesihatan> {
  ...
  saveItem() async {
    ...
    await FirebaseFirestore.instance.collection('kesihatan').add({
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: ((context) => DisplayKesihatan())));
    });
  }
