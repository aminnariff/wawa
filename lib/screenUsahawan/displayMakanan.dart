...
class DisplayMakanan extends StatefulWidget {
  static const routeName = "/displayMakanan";
  const DisplayMakanan({Key? key}) : super(key: key);

  @override
  State<DisplayMakanan> createState() => _ProductListPageState();
}

class _ProductListPageState extends State<DisplayMakanan> {
        ...
        child: ElevatedButton(
          onPressed: () {
            Navigator.of(context).push(
              MaterialPageRoute(builder: ((context) => AddMakanan())),
            );
          },
          child: Text(
            'Tambah',
