...
class AddIklan extends StatefulWidget {
  static const routeName = "/AddIklan";
  const AddIklan({Key? key}) : super(key: key);

  @override
  _AddProductPageState createState() => _AddProductPageState();
}

class _AddProductPageState extends State<AddIklan> {
  ...
  saveItem() async {
    ...
    await FirebaseFirestore.instance.collection('iklan').add({
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: ((context) => DisplayIklan())));
    });
  }
