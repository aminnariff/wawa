...
class AddMakanan extends StatefulWidget {
  static const routeName = "/AddMakanan";
  const AddMakanan({Key? key}) : super(key: key);

  @override
  _AddProductPageState createState() => _AddProductPageState();
}

class _AddProductPageState extends State<AddMakanan> {
  ...
  saveItem() async {
    ...
    await FirebaseFirestore.instance.collection('makanan').add({
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: ((context) => DisplayMakanan())));
    });
  }
