...
class AddGajet extends StatefulWidget {
  static const routeName = "/AddGajet";
  const AddGajet({Key? key}) : super(key: key);

  @override
  _AddProductPageState createState() => _AddProductPageState();
}

class _AddProductPageState extends State<AddGajet> {
  ...
  saveItem() async {
    ...
    await FirebaseFirestore.instance.collection('gajet').add({
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: ((context) => DisplayGajet())));
    });
  }
