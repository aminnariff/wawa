...
class AddPakaian extends StatefulWidget {
  static const routeName = "/AddPakaian";
  const AddPakaian({Key? key}) : super(key: key);

  @override
  _AddProductPageState createState() => _AddProductPageState();
}

class _AddProductPageState extends State<AddPakaian> {
  ...
  saveItem() async {
    ...
    await FirebaseFirestore.instance.collection('pakaian').add({
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: ((context) => DisplayPakaian())));
    });
  }
