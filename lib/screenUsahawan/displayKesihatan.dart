...
class DisplayKesihatan extends StatefulWidget {
  static const routeName = "/displayKesihatan";
  const DisplayKesihatan({Key? key}) : super(key: key);

  @override
  State<DisplayKesihatan> createState() => _ProductListPageState();
}

class _ProductListPageState extends State<DisplayKesihatan> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('kesihatan').snapshots(),
        ...
        child: ElevatedButton(
          onPressed: () {
            Navigator.of(context).push(
              MaterialPageRoute(builder: ((context) => AddKesihatan())),
            );
          },
          child: Text(
            'Tambah',
