...
class DisplayGajet extends StatefulWidget {
  static const routeName = "/displayGajet";
  const DisplayGajet({Key? key}) : super(key: key);

  @override
  State<DisplayGajet> createState() => _ProductListPageState();
}

class _ProductListPageState extends State<DisplayGajet> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: FirebaseFirestore.instance.collection('gajet').snapshots(),
        ...
        child: ElevatedButton(
          onPressed: () {
            Navigator.of(context).push(
              MaterialPageRoute(builder: ((context) => AddGajet())),
            );
          },
          child: Text(
            'Tambah',
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            //   decoration: InputDecoration(labelText: 'Link Pautan'),
            // ),
            SizedBox(
              height: 40,
