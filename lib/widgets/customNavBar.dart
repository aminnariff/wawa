...
import '../screens/displayProfile.dart';
              ...
              child: Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      if (!menu) {
                        Navigator.of(context).pushReplacementNamed(CategoryUsahawan.routeName);
                      }
                    },
                    child: Column(
                  ...
                  GestureDetector(
                    onTap: () {
                      if (!offer) {
                        Navigator.of(context).pushReplacementNamed(DisplayIklan.routeName);
                      }
                    },
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                  ...
                  GestureDetector(
                    onTap: () {
                      if (!profile) {
                        Navigator.of(context).pushReplacementNamed(DisplayProfile.routeName);
                      }
                    },
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.center,
          ...
          Align(
            ...
            child: SizedBox(
              ...
              child: FloatingActionButton(
                ...
                onPressed: () {
                  if (!home) {
                    Navigator.of(context).pushReplacementNamed(HomeScreenUsahawan.routeName);
                  }
                },
