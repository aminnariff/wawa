...
import 'iklanUsahawan.dart';
import 'package:flutter/material.dart';
import 'package:image_picker/image_picker.dart';
import 'package:firebase_storage/firebase_storage.dart' as firabase_storage;
import 'package:http/http.dart' as http;

class UploadIklan extends StatefulWidget {
  static const routeName = "/uploadIklan";
  @override
  State<UploadIklan> createState() => _AccountState();
}

class _AccountState extends State<UploadIklan> {
  String defaultImageUrl =
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQX5-Dd0pOdoNYySmd5--hI4e5f15Z7YVDNslGl6ertsfFwlB2D-NOKPnq_Ngh3zOJNmZU&usqp=CAU';
  String selctFile = '';
  late XFile file;
  ...
  saveItem() async {
    ...
    await FirebaseFirestore.instance.collection('iklan').add({
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: ((context) => IklanUsahawan())));
    });
  }
  ...
  Future<void> sendPushMessage() async {
    ...
    try {
      ...
      await http.post(
        ...
        headers: <String, String>{'Content-Type': 'application/json; charset=UTF-8', 'Authorization': 'key=$serverKey'},
        body: constructFCMPayload(_descriptionController.text),
      );
